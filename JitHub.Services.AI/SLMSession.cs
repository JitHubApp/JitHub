...
{
    private const string DEFAULT_SYSTEM_PROMPT = "You are a helpful AI assistant. The user will be asking you questions or finish a task. You will try to use the user by answering those questions or completing the tasks like writing or generating text. If the answer is not of high ocnfident, say you don't know.";
